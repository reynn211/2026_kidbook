...
Внутри каждой папки создаются под-папки - по одной на каждую группу. Называть их рекомендуется в соответствии с тематическим разделом. Например, группа, отвечющая за развлечения, будет хранить рабочие материалы в папке `WORK/enteratinment`, а финальные HTML-страницы размещать в `WEB/entertainment`.
